...
# if __BYTE_ORDER == __LITTLE_ENDIAN
    ...
    void process_frame(AP_RCProtocol_CRSF::FrameType frame_type, void* data);
...
private:
    ...
    bool _freq_update;  // update using the frequency method or not
    bool _dbm_update; // update using the dbm method or not
