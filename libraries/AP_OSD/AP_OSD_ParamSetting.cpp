...
static const char* SERIAL_PROTOCOL_VALUES[] = {
    ...
    "NMEA", "WNDVNE", "SLCAN", "RCIN", "MGSQRT", "LTM", "RUNCAM", "HOT_TLM", "SCRIPT", "CRSF", "GEN", "WNCH"
};
...
{
    _current_token = AP_Param::ParamToken {};
    _param = AP_Param::find_by_name(name, &_param_type, &_current_token);

    if (_param == nullptr) {
        enabled.set_and_save_ifchanged(false);
        return false;
    } else {
