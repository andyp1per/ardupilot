...
private:
     ...
     */
    //HAL_EventSemaphore *rate_loop_sem;
    HAL_ConcurrentObjectBuffer<Vector3f> _rate_loop_gyro_window{AP_INERTIAL_SENSOR_RATE_LOOP_BUFFER_SIZE};
    uint8_t rate_decimation = 1;
    uint8_t rate_decimation_count;

public:
    //void set_rate_loop_sem(HAL_EventSemaphore *sem) { rate_loop_sem = sem; }
