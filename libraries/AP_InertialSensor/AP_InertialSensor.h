...
typedef ObjectBuffer<float> GyroWindow;
...
public:
    ...
    GyroWindow&  get_raw_gyro_window(uint8_t instance, uint8_t axis) { return _gyro_window[instance][axis]; }
    GyroWindow&  get_raw_gyro_window(uint8_t axis) { return get_raw_gyro_window(_primary_gyro, axis); }
