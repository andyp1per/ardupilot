...
''')
        ...
        if storage_flash_page is not None:
            ...
            if self.is_bootloader_fw():
                f.write('#define STORAGE_FLASH_START_KB %u\n' % self.get_flash_page_offset_kb(storage_flash_page))
                f.write('#define STORAGE_FLASH_END_KB %u\n' % self.get_flash_page_offset_kb(storage_flash_page+2))
