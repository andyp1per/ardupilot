...
#        self.delay_sim_time(30)
    ...
    def install_driver_script_context(self, scriptname, **kwargs):
        '''installs an driver script which will be removed when the context goes
        away'''
        self.install_driver_script(scriptname, **kwargs)
        self.context_get().installed_scripts.append(scriptname)
