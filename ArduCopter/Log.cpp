...
struct PACKED log_Filter_Tuning {
    ...
    float    motor_peak_simple_fft_z;
    float    motor_peak_quinns_fft_z;
...
void Copter::Log_Write_Filter_Tuning()
{
    struct log_Filter_Tuning pkt = {
        ...
        motor_peak_simple_fft_z    : analyse_noise.get_simple_center_freq_hz().z,
        motor_peak_quinns_fft_z    : analyse_noise.get_quinns_center_freq_hz().z,
...
const struct LogStructure Copter::log_structure[] = {
    ...
    { LOG_FILTER_TUNING_MSG, sizeof(log_Filter_Tuning),
      "FTUN", "Qfffffffff", "TimeUS,ThO,ThH,MotPeakX,MotPeakY,MotPeakZ,MPSZ,MPQZ,BE,DNtch", "s--zzzz", "F------" },  
