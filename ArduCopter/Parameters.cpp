...
const AP_Param::GroupInfo ParametersG2::var_info2[] = {
    ...
    // @Values: 0:Disabled/NoAction,1:Land, 2:RTL, 3:SmartRTL or RTL, 4:SmartRTL or Land, 6:Auto DO_LAND_START or RTL
    // @User: Advanced
    AP_GROUPINFO("FS_MR_ENABLE", 6, ParametersG2, failsafe_mr_enable, (uint8_t)Copter::FailsafeAction::RTL),
    ...
    // @Units: ms
    // @User: Advanced
    AP_GROUPINFO("FS_MR_TIMEOUT", 7, ParametersG2, failsafe_mr_timeout, 0),
#endif
